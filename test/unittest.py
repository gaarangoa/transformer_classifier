...
inp = tf.random.uniform((5, 20))  # 5 sentences of 20 tokens each
tar = tf.random.uniform((5, 1))  #  5 target lables of 1 token (class)
...
sample_decoder = Decoder(
    num_layers=1, d_model=512, num_heads=1, dff=2048, target_vocab_size=2
)
